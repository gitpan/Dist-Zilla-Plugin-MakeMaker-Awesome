...
{
  $Dist::Zilla::Plugin::MakeMaker::Awesome::VERSION = '0.18';
}
# git description: v0.17-5-gf500ffe
...
=for :stopwords Ævar Arnfjörð Bjarmason Jesse Luehrs Karen Etheridge Robin Smidsrød distro
dirs sharedir INI
