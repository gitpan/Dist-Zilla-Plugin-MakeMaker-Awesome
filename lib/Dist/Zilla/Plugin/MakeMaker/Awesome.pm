...
{
  $Dist::Zilla::Plugin::MakeMaker::Awesome::VERSION = '0.16';
}
# git description: v0.15-4-g65e44a7
...
# This Makefile.PL for {{ $distname }} was generated by {{ ref $plugin }} {{ $plugin->VERSION || '<self>' }}.
...
=for :stopwords Ã†var ArnfjÃ¶rÃ° Bjarmason Jesse Luehrs Karen Etheridge Robin Smidsrød Ævar
Arnfjörð distro dirs sharedir INI
